...
// Fixed: replaced the conditional require with direct extend
...
export default function LanyardReact({ position = [0, 0, 20], gravity = [0, -40, 0], fov = 17, transparent = true }) {
  return (
